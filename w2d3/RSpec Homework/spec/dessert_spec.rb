...
describe Dessert do
  let(:chef) { double("chef", name: "Alvin") }
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      brownie.add_ingredient("cauliflower")
      expect(brownie.ingredients).to include("cauliflower")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["ground beef", "flower", "sugar"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Chef Alvin the Great Baker has made 50 brownies!")
    end
  end
